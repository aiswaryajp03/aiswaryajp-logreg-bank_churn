...
### ROC Curve
The **Receiver Operating Characteristic (ROC)** curve plots the **True Positive Rate (TPR)** against the **False Positive Rate (FPR)** across different classification thresholds.
